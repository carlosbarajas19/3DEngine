...
bool nc::json::Get(const rapidjson::Value& value, const std::string& name, glm::vec2& data)
{
...
bool nc::json::Get(const rapidjson::Value& value, const std::string& name, glm::vec3& data)
{
...
bool nc::json::Get(const rapidjson::Value& value, const std::string& name, glm::vec4& data)
{
	// check if 'name' member exists and is an array with 3 elements
